...
import { Bold, Code, Italic, Link, List, Quote, TextSize } from './assets'
...
const ToolBar = ({
  ...
  return (
    <ToolBarBox>
      ...
      <ToolBarButton theme={theme} onClick={setSelectionCode} compact>
        <Code />
      </ToolBarButton>
      <ToolBarButton theme={theme} onClick={setSelectionLink} compact>
        <Link />
      </ToolBarButton>
      <ToolBarButton theme={theme} onClick={setSelectionUnorderedList} compact>
        <List />
      </ToolBarButton>
      <ToolBarSeparator />
    </ToolBarBox>
